...
Make sure to replace `your-username` with the actual username of your GitHub account in the cloning URL.

This should help your team get set up quickly and ensure consistent coding practices.
```
````
